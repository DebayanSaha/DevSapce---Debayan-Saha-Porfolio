        ...
        <div className='h-screen*2 w-full p-4 bg-black mt-10'>
            <div className='relative h-[40vw] rounded-4xl bg-white p-3.5'>
                <div className='relative h-full w-full rounded-[20px] overflow-hidden'>
                    <video autoPlay loop muted className=' absolute object-cover' src="/src/assets/vids/work.mp4"></video>
            ...
            <div className='relative h-[45vw] p-3.5 mt-5 rounded-[20px] flex items-center justify-center'>
                ...
                <img className='absolute h-[93vh]' src="/src/assets/background/astro.png" alt="" />
                <video className='h-[35vh]  mb-30 object-cover rounded-full' autoPlay muted loop src="/src/assets/vids/k72vid.mp4"></video>
            </div>
        </div>
    </>     
  )
